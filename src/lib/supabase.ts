...
import {
  ...
  ArrowRight, Building, Sparkles, Eye, DollarSign, Zap, Crown
} from 'lucide-react';
...
const HowItWorksPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white page-container">
      ...
      <section className="py-24 bg-gradient-to-br from-white via-gray-50 to-primary-50/30 relative overflow-hidden">
        {/* Background Elements */}
