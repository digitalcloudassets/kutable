                  ...
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {['10:00', '10:30', '11:00', '11:30', '12:00', '12:30'].map((time) => (
                        <button
                          key={time}
                          className="p-2 text-sm border rounded hover:border-orange-500 transition-colors"
                        >
                          {time}
                        </button>
                      ))}
                ...
                <div className="bg-gray-100 rounded-lg p-8">
                  ...
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <div className="flex space-x-2">
                      <button className="flex-1 bg-orange-500 text-white py-2 px-3 rounded text-sm">
                        Get Directions
                      </button>
                      <button className="flex-1 border border-gray-300 py-2 px-3 rounded text-sm">
                        Call Barber
                      </button>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/signup"
              className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors flex items-center justify-center space-x-2"
            >
