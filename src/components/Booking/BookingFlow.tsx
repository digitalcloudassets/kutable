          ...
          <div className="max-w-2xl mx-auto px-4 py-8">
            ...
            <div className="card-premium p-6 sm:p-8 mb-8 relative z-10 animate-fade-in-up">
              <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 text-center sm:text-left">
                ...
                />
                <div>
                  <h1 className="text-2xl sm:text-3xl font-display font-bold text-gray-900 mb-2">Barber Not Found</h1>
                  <p className="text-gray-600 font-medium text-lg">Please check the link and try again</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 relative z-10">
              <BookingStepper current={1} total={5} />
            </div>

            {/* Step Content */}
            <div className="card-premium relative z-10 animate-fade-in-up p-8 text-center">
              <p className="text-gray-600">The barber profile you're looking for could not be found.</p>
            </div>
          </div>
        </div>
      </>
